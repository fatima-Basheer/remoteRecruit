...
function GlobalReach() {
  ...
  useEffect(() => {
    ...
    return () => {
      ScrollTrigger.getById(sectionRef.current)?.kill();
    };
  }, []);
  return (
    <section
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          <div className="relative w-full sm:max-w-[420px] bg-transparent sm:bg-white rounded-none sm:rounded-2xl sm:shadow-2xl sm:shadow-sky-100 sm:border sm:border-gray-100 overflow-visible p-0 sm:p-3 sm:pb-8 flex flex-col gap-6">
            ...
            <div className="absolute top-1/2 -right-[40px] md:-right-[60px] -translate-y-1/2 w-30 h-30 rounded-full flex items-center justify-center z-20 hidden sm:flex overflow-hidden">
              <img
                src="./Group 132.png"
                alt="Floating Logo"
            ...
            <div className="flex flex-col gap-4 relative w-full px-4 sm:px-0">
              ...
              <div
                className={`w-full bg-white rounded-full p-1 shadow-xl border border-[#f6f4ff] flex items-center gap-4 transition-all duration-1000 delay-500 ease-out transform
                  ${isVisible ? "sm:translate-x-[10%] opacity-100" : "sm:translate-x-0 opacity-0"}`}
              >
                <div className="w-12 h-12 rounded-full p-[3px] bg-gradient-to-r from-[#FFED43] to-[#F29939] flex-shrink-0">
                  <div className="w-full h-full rounded-full overflow-hidden">
                    <img
